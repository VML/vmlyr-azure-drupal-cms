...
class ContextualLinksTest extends WebDriverTestBase {
   ...
   * {@inheritdoc}
   */
  public static $modules = ['block', 'contextual', 'node', 'views', 'views_ui'];
 ...
 public function testSameContextualLinks() {
   $this->drupalPlaceBlock('views_block:content_recent-block_2', ['id' => 'first']);
   $this->drupalPlaceBlock('views_block:content_recent-block_2', ['id' => 'second']);
