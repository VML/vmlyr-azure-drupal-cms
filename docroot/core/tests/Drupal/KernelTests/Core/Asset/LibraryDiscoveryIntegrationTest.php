...
class LibraryDiscoveryIntegrationTest extends KernelTestBase {
  ...
  public function testLibrariesOverrideOverriddenOrder() {
    ...
    $this->assertNoAssetInLibrary('core/modules/system/tests/themes/test_subtheme/css/ensure-order.css', 'test_basetheme', 'global-styling', 'css');
    // Get assets for base_theme.
    $original_assets = array_column($this->libraryDiscovery->getLibraryByName('test_basetheme', 'global-styling')['css'], 'data');

    // Activate a subtheme with overrides.
    $this->activateTheme('test_subtheme');
    // Assert asset is applied in subtheme.
    $this->assertNoAssetInLibrary('core/modules/system/tests/themes/test_basetheme/ensure-order.css', 'test_basetheme', 'global-styling', 'css');
    $this->assertAssetInLibrary('core/modules/system/tests/themes/test_subtheme/css/ensure-order.css', 'test_basetheme', 'global-styling', 'css');

    // Get overridden assets.
    $overridden_assets = array_column($this->libraryDiscovery->getLibraryByName('test_basetheme', 'global-styling')['css'], 'data');

    // Overridden asset should be at same position in array.
    $this->assertEquals(
      array_search('core/modules/system/tests/themes/test_basetheme/ensure-order.css', $original_assets, TRUE),
  ...
  public function testLibrariesOverrideOverridden() {
    ...
    $this->assertAssetInLibrary('core/modules/system/tests/themes/test_basetheme/css/farbtastic.css', 'core', 'jquery.farbtastic', 'css');
    $this->assertAssetInLibrary('core/modules/system/tests/themes/test_basetheme/css/normalize.css', 'core', 'normalize', 'css');

    // Activate a sub-theme that overrides a library override.
    $this->activateTheme('test_subsubtheme');

    // Assert that effective libraries override is from the test_subsubtheme.
    $this->assertNoAssetInLibrary('core/modules/system/tests/themes/test_basetheme/css/normalize.css', 'core', 'normalize', 'css');
    ...
    $this->assertNoAssetInLibrary('core/modules/system/tests/themes/test_basetheme/css/core.css', 'core', 'jquery.ui', 'css');
    $this->assertAssetInLibrary('core/modules/system/tests/themes/test_subtheme/css/core.css', 'core', 'jquery.ui', 'css');
  }
   ...
   *
   * @group legacy
   * @expectedDeprecationMessage Overriding a library asset using an overridden path as key is deprecated, please use the original path as key.
   */
  public function testLibrariesOverrideLegacyOverride() {
    // Activate a sub-theme that overrides a library override.
    $this->activateTheme('test_legacysubtheme');
    // Assert that effective libraries override is from the test_legacysubtheme.
    ...
    $this->assertAssetInLibrary('core/modules/system/tests/themes/test_legacysubtheme/css/legacysubtheme-farbtastic.css', 'core', 'jquery.farbtastic', 'css');
  }
