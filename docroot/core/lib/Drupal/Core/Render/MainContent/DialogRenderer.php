...
class DialogRenderer implements MainContentRendererInterface {
  ...
  public function renderResponse(array $main_content, Request $request, RouteMatchInterface $route_match) {
    ...
    // If the main content doesn't provide a title, use the title resolver. Make
    // sure to pass only a string value.
    $title = isset($main_content['#title']) && \is_string($main_content['#title']) ? $main_content['#title'] : $this->titleResolver->getTitle($request, $route_match->getRouteObject());
